# TiMP
# RK1 - Llama2
# Llama 2 - это чат-бот, разработанный компанией Meta AI, также известный как Meta AI с большой языковой моделью. Он использует обработку естественного языка (NLP) для работы с вводимыми людьми данными, генерирует текст, отвечает на сложные вопросы и способен вести естественные и увлекательные беседы с пользователями.
# 3. Количество файлов 
```
ls . | wc -l
23
